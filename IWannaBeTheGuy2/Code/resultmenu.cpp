    ...
    ui(new Ui::ResultMenu)
{
    ...
    QPixmap backGround(":/Images/Resultat.png");
    QPalette palette = this->palette();
    palette.setBrush(QPalette::Window,
    QBrush(backGround));
    setPalette(palette);
    setFixedSize(backGround.size());
    QPixmap pixmap(":/Images/suivant.png");
    ...
    pixmap.load(":/Images/rejouer.png");
    ...
    {
        itsFile = "../Code/Textes/HallOfFameLevel1.txt";
    }
    else if(itsFile== ":/Textes/niveau2.txt")
    {
        itsFile = "../Code/Textes/HallOfFameLevel2.txt";
        ui->nextButton->setVisible(false);
    }
    else
    {
        itsFile = "../Code/Textes/HallOfFameTuto.txt";
    }
    displayHallOfFame();
}
...
void ResultMenu::on_nextButton_clicked()
{
    ...
    itsNumButton = 2;
    string nomNiveau="";
    if(itsFile=="../Code/Textes/HallOfFameTuto.txt")
    {
        nomNiveau=":/Textes/niveau1.txt";
    }
    if(itsFile=="../Code/Textes/HallOfFameLevel1.txt")
    {
        nomNiveau=":/Textes/niveau2.txt";
    }
