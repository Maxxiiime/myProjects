    ...
    ui(new Ui::TheGameLoop)
{
    ...
    setWindowIcon(QIcon(":/Images/pomme.png"));
    setWindowTitle("I Wanna Be the Guy 2.0 - "+ QString::fromStdString(aFileName));

    itsFile=aFileName;
    if(itsFile!=":/Textes/secret.txt")
    {
      setFixedSize(1000,768);
    }
    else if(itsFile ==":/Textes/secret.txt")
    {
    ...
    if(itsFile != ":/Textes/levelTuto.txt")
    {
    ...
    pauseSound= new QSound(":/Audios/pause.wav");
    coinSound= new QSound(":/Audios/coinsound.wav");
    stageSound= new QSound(":/Audios/stageClear.wav");
    gameoverSound= new QSound(":/Audios/gameOver.wav");
    dieSound= new QSound(":/Audios/marioDie.wav");
...
void TheGameLoop::constructionNiveau(){
    ...
    if(itsFile!=":/Textes/secret.txt")
    {
        ...
        QBrush(QPixmap(":/Images/fondecran.png").scaled(3840,768,Qt::IgnoreAspectRatio,Qt::SmoothTransformation)));
        setPalette(palette);
    }
    else if(itsFile==":/Textes/secret.txt")
    {
        palette = this->palette();
        palette.setBrush(QPalette::Window,
        QBrush(QPixmap(":/Images/fondecran.png").scaled(672,768,Qt::IgnoreAspectRatio,Qt::SmoothTransformation)));
        setPalette(palette);
    }
    ...
    QString leFichier = QString::fromStdString(itsFile);
    QFile aFile(leFichier);
    QTextStream flux(&aFile);


    //ifstream aFile(itsFile);
    ...
    if(itsFile == ":/Textes/niveau1.txt")
    {
        strColonne = "250";
        strLigne = "16";
    }
    if(itsFile == ":/Textes/niveau2.txt")
    {
        strColonne = "240";
        strLigne = "16";
    }
