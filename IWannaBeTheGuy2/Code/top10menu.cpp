    ...
    ui(new Ui::Top10Menu)
{
    ...
    QPixmap backGround(":/Images/MenuTop10.png");
    QPalette palette = this->palette();
    palette.setBrush(QPalette::Window,
    QBrush(backGround));
    setPalette(palette);
    setFixedSize(backGround.size());
    QPixmap pixmap(":/Images/menu.png");;
    ...
    displayHallOfFame("../Code/Textes/HallOfFameTuto.txt");
}
...
{
    displayHallOfFame("../Code/Textes/HallOfFameLevel1.txt");
}

void Top10Menu::on_radioButtonLevel2_clicked()
{
    displayHallOfFame("../Code/Textes/HallOfFameLevel2.txt");
}
